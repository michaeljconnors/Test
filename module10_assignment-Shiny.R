...
setwd(dir = "/Users/michaelconnors/desktop")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      selectInput(inputId = "set_yaxis", label = "income category",
                  choices = c(Hours_Per_Week = "hours_per_week", CapitalLoss = "capital_loss")),
